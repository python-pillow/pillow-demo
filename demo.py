...
region.save("cropped_hopper.ppm")
...
im.save("flip_left_right_hopper.ppm")
...
im.save("flip_top_bottom_hopper.ppm")
print("Saved flipped hopper!")
code.interact(local=globals())

# ===============================================================================
# Example #12 Rotate image 90 degrees with transpose
# https://pillow.readthedocs.io/en/stable/handbook/tutorial.html#transposing-an-image
# ===============================================================================
im = Image.open("hopper.ppm")
im = im.transpose(Image.Transpose.ROTATE_90)
im.save("rotated_hopper_90.ppm")
print("Saved rotated hopper!")
code.interact(local=globals())

# ===============================================================================
# Example #13 Rotate image 180 degrees with transpose
# https://pillow.readthedocs.io/en/stable/handbook/tutorial.html#transposing-an-image
# ===============================================================================
im = Image.open("hopper.ppm")
im = im.transpose(Image.Transpose.ROTATE_180)
im.save("rotated_hopper_180.ppm")
print("Saved rotated hopper!")
code.interact(local=globals())

# ===============================================================================
# Example #14 Rotate image 270 degrees with transpose
# https://pillow.readthedocs.io/en/stable/handbook/tutorial.html#transposing-an-image
# ===============================================================================
im = Image.open("hopper.ppm")
im = im.transpose(Image.Transpose.ROTATE_270)
im.save("rotated_hopper_270.ppm")
print("Saved rotated hopper!")
code.interact(local=globals())

# ===============================================================================
# Example #15 Relative resize image with contain
...
# ===============================================================================
# Example #16 Relative resize image with cover
# https://pillow.readthedocs.io/en/stable/handbook/tutorial.html#relative-resizing
# ===============================================================================
im = Image.open("hopper.ppm")
...
# ===============================================================================
# Example #16 Relative resize image with fit
# https://pillow.readthedocs.io/en/stable/handbook/tutorial.html#relative-resizing
# ===============================================================================
im = Image.open("hopper.ppm")
...
# ===============================================================================
# Example #17 Relative resize image with fit
# https://pillow.readthedocs.io/en/stable/handbook/tutorial.html#relative-resizing
# ===============================================================================
im = Image.open("hopper.ppm")
